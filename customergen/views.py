...
def generate_customer_view(request):
    ...
    glue_query_set(request, unique_name='customers', target=customers, access='delete')
...
def edit_customer(request):
    if request.method == 'GET':
        ...
        glue_model_object(request, 'customer', customer, access='delete')
    ...
    if request.method == 'POST':
        ...
        glue_model_object(request, 'customer', new_customer, access='delete')
